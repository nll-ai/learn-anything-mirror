(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,95742,e=>{"use strict";var a=e.i(43476),t=e.i(71645),i=e.i(22016),n=e.i(18566);e.i(50711);var r=e.i(82045),o=e.i(20565),s=e.i(83394);function l(e,t){return e.split(/(\*\*[^*]+\*\*)/g).map((e,i)=>e.startsWith("**")&&e.endsWith("**")?(0,a.jsx)("strong",{children:e.slice(2,-2)},`${t}-${i}`):(0,a.jsx)("span",{children:e},`${t}-${i}`))}function c(e){return e.replace(/^\|/,"").replace(/\|$/,"").split("|").map(e=>e.trim())}function d({cell:e,header:t=!1,k:i}){return(0,a.jsx)(t?"th":"td",{children:l(e,i)},i)}function h({rows:e,k:t}){let i=e.filter(e=>!/^\|(\s*:?-+:?\s*\|)+\s*$/.test(e));if(0===i.length)return null;let[n,...r]=i;return(0,a.jsxs)("table",{children:[(0,a.jsx)("thead",{children:(0,a.jsx)("tr",{children:c(n).map((e,t)=>(0,a.jsx)(d,{cell:e,header:!0,k:`h${t}`},`h${t}`))})}),(0,a.jsx)("tbody",{children:r.map((e,t)=>(0,a.jsx)("tr",{children:c(e).map((e,i)=>(0,a.jsx)(d,{cell:e,k:`c${t}-${i}`},`c${t}-${i}`))},t))})]},t)}function u({markdown:e}){let t=[],i=[],n=!1,r=[],o=[],s=e=>{if(0===i.length)return;let r=i.map((t,i)=>(0,a.jsx)("li",{children:l(t,`${e}-${i}`)},i));t.push(n?(0,a.jsx)("ol",{children:r},e):(0,a.jsx)("ul",{children:r},e)),i=[]},c=e=>{0!==o.length&&(t.push((0,a.jsx)("p",{children:l(o.join(" "),e)},e)),o=[])},d=e=>{0!==r.length&&(t.push((0,a.jsx)(h,{rows:r,k:e},e)),r=[])};return e.split("\n").forEach((e,h)=>{let u=`b${h}`,p=e.trim();p.startsWith("### ")?(c(`${u}-p`),s(`${u}-l`),d(`${u}-t`),t.push((0,a.jsx)("h4",{children:l(p.slice(4),u)},u))):p.startsWith("## ")?(c(`${u}-p`),s(`${u}-l`),d(`${u}-t`),t.push((0,a.jsx)("h3",{children:l(p.slice(3),u)},u))):p.startsWith("# ")?(c(`${u}-p`),s(`${u}-l`),d(`${u}-t`),t.push((0,a.jsx)("h2",{children:l(p.slice(2),u)},u))):p.startsWith("|")?(c(`${u}-p`),s(`${u}-l`),r.push(p)):r.length>0?(d(`${u}-t`),""===p?(c(`${u}-p`),s(`${u}-l`)):p.startsWith("- ")?(c(`${u}-p`),n=!1,i=[p.slice(2)]):/^\d+\.\s/.test(p)?(c(`${u}-p`),n=!0,i=[p.replace(/^\d+\.\s/,"")]):i.length>0?i[i.length-1]+=` ${p}`:o.push(p)):p.startsWith("- ")?(c(`${u}-p`),i&&!n?i.push(p.slice(2)):(s(`${u}-l0`),n=!1,i=[p.slice(2)])):/^\d+\.\s/.test(p)?(c(`${u}-p`),n?i.push(p.replace(/^\d+\.\s/,"")):(s(`${u}-l1`),n=!0,i=[p.replace(/^\d+\.\s/,"")])):""===p?(c(`${u}-p`),s(`${u}-l`)):i.length>0?i[i.length-1]+=` ${p}`:o.push(p)}),c("tail-p"),s("tail"),d("tail-t"),(0,a.jsx)("div",{className:"legal-doc",children:t})}let p=`# Participant Agreement (Terms & Conditions) — Learn Anything Retreat
...
of the Deposit Terms made by your deposit payment or by any payment made on your behalf.`,m=`# Liability Waiver & Release — Learn Anything Retreat
...
name, or date of birth is collected.`,y=`# Privacy Notice — Learn Anything Retreat
...
your rights and freedoms, we will inform you without undue delay.`;var g=e.i(19923),f=e.i(93903);let b={terms_being_finalized:"Your participant terms are being finalized — we'll email you when your acceptance link is live.",invalid_link:"This link isn't valid. Links are personal and can't be reconstructed — use the link in your email exactly as sent, or reply to that email and we'll send a fresh one.",link_expired:"This link has expired (the balance deadline has passed). Email us and we'll sort it out under the Participant Agreement.",stage_not_billable_closed:"This entry is closed. If you think that's a mistake, reply to your invitation email.",stage_not_billable_cancelled:"This entry was cancelled. If you think that's a mistake, reply to your invitation email.",deposit_not_paid:"We don't have a confirmed deposit on file for this entry yet — this page opens once your deposit is paid. Reply to your invitation email if that's a surprise.",billing_name_required:"Your entry is missing the name the invoice should be made out to. Reply to your email with your full name and we'll fix it — then this page will work.",participant_acceptance_required:"We couldn't record your acceptance — nothing was charged. Please try again, or reply to your email for help.",stage_not_billable:"This entry can't be billed right now. Reply to your email and we'll fix it.",stuck_void_use_retry_void:"Preparing your invoice hit a snag on our side. Reply to your email and we'll fix it — nothing has been charged.",errored_balance_use_retry:"Preparing your invoice hit a snag. Reply to your email and we'll fix it — nothing has been charged."};function v(e){return b[e.startsWith("stage_not_billable:")?`stage_not_billable_${e.split(":")[1]}`:e.split(":")[0]]??b[e]??e}function w(){return(0,a.jsx)("svg",{className:"acc-chev",width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:(0,a.jsx)("path",{d:"M4 2.5 L8 6 L4 9.5",fill:"none",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})}function x({state:e,entryId:t,token:i}){switch(e.state){case"gate_closed":return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("h1",{className:"shell-title",children:"Your seat is held."}),(0,a.jsx)("section",{className:"panel acc-notice",children:(0,a.jsxs)("p",{children:["Your participant terms are being finalized. We'll email your personal acceptance link as soon as they are —"," ",(0,a.jsx)("strong",{children:"your seat is already held"}),", and there is nothing you need to do right now."]})})]});case"invalid_link":return(0,a.jsx)(k,{title:"Your participant terms.",children:b.invalid_link});case"expired":return(0,a.jsx)(k,{title:"Your participant terms.",children:b.link_expired});case"unavailable":return(0,a.jsx)(k,{title:"Your participant terms.",children:b[`stage_not_billable_${e.reason}`]??"This entry is not open for acceptance. Reply to your email and we'll help."});case"deposit_not_paid":return(0,a.jsx)(k,{title:"Your participant terms.",children:b.deposit_not_paid});case"paid":return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("h1",{className:"shell-title",children:"You're fully enrolled."}),(0,a.jsx)("section",{className:"panel acc-notice",children:(0,a.jsx)("p",{children:"Your terms are on file and the tuition is settled — we'll email you everything you need before the retreat."})})]});case"invoice_error":return(0,a.jsx)(T,{entryId:t,token:i});case"preparing":return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("h1",{className:"shell-title",children:"Your invoice is being prepared."}),(0,a.jsx)("section",{className:"panel acc-notice",children:(0,a.jsx)("p",{children:"Your terms are recorded and your balance invoice is being prepared. This page updates by itself — keep it open."})})]});case"invoice_ready":return(0,a.jsx)(I,{state:e});case"ready":return(0,a.jsx)(O,{name:e.name,entryId:t,token:i});default:return(0,a.jsx)(k,{title:"Your participant terms.",children:"Unexpected state — reply to your email and we'll help."})}}function k({title:e,children:t}){return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("h1",{className:"shell-title",children:e}),(0,a.jsx)("section",{className:"panel acc-notice",children:(0,a.jsx)("p",{children:t})})]})}let R=[{key:"participantAgreement",name:"Participant Agreement",qualifier:"Terms & Conditions",updated:"September 24, 2026",body:p.replace(/^# .*$/m,"").trim(),checkbox:g.LEGAL_CHECKBOX.participantAgreement,summary:["This is the contract for your spot. Tuition is $4,997 — lodging, meals, and materials included, travel is not — and your $4,897 balance is due January 15, 2027.","Your $100 deposit is fully refundable for any reason until the retreat begins. Cancel by January 15, 2027, and everything you have paid is refunded.","Cancel after January 15, 2027, and the balance is refunded only if your spot is filled from the waitlist. If the Organizers cancel or make a major change to the retreat, you get a full refund.","Participants are expected to treat each other with respect and can be removed for serious disruption. Declining this agreement ends participation — with everything paid refunded within 14 days."]},{key:"liabilityWaiver",name:"Liability Waiver",qualifier:"& Release",updated:"September 24, 2026",body:m.replace(/^# .*$/m,"").trim(),checkbox:g.LEGAL_CHECKBOX.liabilityWaiver,summary:["This is a legally binding waiver: by accepting it you give up substantial legal rights, including your right to sue. The text itself asks you not to accept it if any part is unclear, and to consult an attorney first.","You accept that the retreat carries inherent risks — things like food allergies and illness, use of the venue and its facilities, and travel arranged by the Organizers. The Organizers make a best effort to mitigate those risks; responsibility for the risks that remain is yours.","You release the Organizers, their team, and the venue from claims arising out of the retreat — including claims from ordinary negligence — except where caused by gross negligence, recklessness, or willful misconduct, or where the law does not allow.","You are responsible for your own health insurance and any medical costs if something happens. Accepting also covers your health disclosure (§5) and how session recordings are handled (§6)."]},{key:"privacyNotice",name:"Privacy Notice",qualifier:"",updated:"September 24, 2026",body:y.replace(/^# .*$/m,"").trim(),checkbox:g.LEGAL_CHECKBOX.privacyNotice,summary:["What we collect: your enrollment details, payment and billing data (cards are handled by Stripe — we never store card numbers), your health and emergency-contact disclosures, session recordings, and basic product analytics.","Accepting the documents on this page creates an acceptance record — document version, checkbox text, date and time, your IP address where available, and a content hash — kept as evidence that you accepted.","Who processes your data: us, plus Stripe (payments), Convex (hosting), PostHog (analytics), our email provider, and transcription services under confidentiality contracts. Data is hosted in the United States.","Session recordings stay in the cohort archive until you ask us to delete them — email eric.ma@nonlinearlabs.ai and we honor it within 30 days. The full notice lists your rights (EU/UK/Canada) and how to use them."]}];function O({name:e,entryId:i,token:n}){let[l,c]=(0,t.useState)({}),[d,h]=(0,t.useState)({}),[p,m]=(0,t.useState)(!1),[y,g]=(0,t.useState)(null),b=(0,r.useMutation)(s.api.acceptLink.accept),x=(0,o.usePostHog)(),k=R.every(e=>l[e.key]),T=R.every(e=>d[e.key]),I=k&&T;async function j(){let e;m(!0),g(null);try{let a=await fetch("/api/ip");a.ok&&(e=(await a.json()).ip??void 0)}catch{}try{let a=await b({entryId:i,token:n,ip:e});if(!a.ok){g(v(a.error??"")),m(!1);return}x?.capture("accept_balance_terms_accepted")}catch{g("Something went wrong. Please try again."),m(!1)}}return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("h1",{className:"shell-title",children:"Your seat is held."}),(0,a.jsxs)("section",{className:"panel acc-ledger",children:[(0,a.jsxs)("div",{className:"ledger",children:[(0,a.jsxs)("div",{className:"ledger-row",children:[(0,a.jsxs)("div",{className:"ledger-info",children:[(0,a.jsx)("span",{className:"ledger-name",children:"Deposit"}),(0,a.jsxs)("span",{className:"ledger-sub",children:[(0,f.formatUsd)(f.DEPOSIT_AMOUNT_CENTS)," · received and credited toward your tuition"]})]}),(0,a.jsx)("span",{className:"ledger-stamp",children:"Received"})]}),(0,a.jsxs)("div",{className:"ledger-row",children:[(0,a.jsxs)("div",{className:"ledger-info",children:[(0,a.jsx)("span",{className:"ledger-name",children:"Balance"}),(0,a.jsxs)("span",{className:"ledger-sub",children:[(0,f.formatUsd)(f.BALANCE_AMOUNT_CENTS)," · due ",f.BALANCE_DUE_LABEL]})]}),(0,a.jsx)("span",{className:"ledger-stamp acc-stamp-due",children:"Due Jan 15"})]})]}),(0,a.jsxs)("p",{className:"acc-note",children:[e?(0,a.jsxs)(a.Fragment,{children:["Hi ",e," — "]}):null,"your deposit is in, and it holds your seat. What remains: read the three documents below and check each box. Your balance invoice opens here the moment you accept. No account needed — this page is your personal link."]})]}),(0,a.jsx)("p",{className:"acc-section-label",children:"The three documents"}),R.map(e=>(0,a.jsxs)("details",{className:"acc-doc",onToggle:a=>{a.target.open&&c(a=>({...a,[e.key]:!0}))},children:[(0,a.jsxs)("summary",{children:[(0,a.jsx)(w,{}),(0,a.jsxs)("span",{className:"acc-doc-id",children:[(0,a.jsx)("span",{className:"acc-doc-name",children:e.name}),e.qualifier?(0,a.jsx)("span",{className:"acc-doc-qualifier",children:e.qualifier}):null]}),l[e.key]?(0,a.jsx)("span",{className:"ledger-stamp acc-stamp-read",children:"Read"}):(0,a.jsx)("span",{className:"acc-open-hint",children:"open to read — unlocks its checkbox"})]}),(0,a.jsxs)("div",{className:"acc-doc-body",children:[(0,a.jsxs)("div",{className:"acc-plain",children:[(0,a.jsx)("p",{className:"acc-plain-label",children:"In plain English"}),(0,a.jsx)("p",{className:"acc-plain-disclaimer",children:"Provided for convenience only — this summary is not part of the document and does not change it. If it differs from the full text in any way, the full text below governs."}),(0,a.jsx)("ul",{children:e.summary.map((e,t)=>(0,a.jsx)("li",{children:e},t))})]}),(0,a.jsxs)("p",{className:"acc-doc-updated",children:["Last updated ",e.updated]}),(0,a.jsx)(u,{markdown:e.body})]})]},e.key)),(0,a.jsxs)("section",{className:`panel acc-sign${I?" acc-sign-live":""}`,children:[(0,a.jsx)("h3",{children:"Your signature"}),(0,a.jsx)("div",{className:"acc-checks",children:R.map(e=>(0,a.jsxs)("label",{className:"legal-agree",children:[(0,a.jsx)("input",{type:"checkbox",disabled:!l[e.key],checked:!!d[e.key],onChange:a=>h(t=>({...t,[e.key]:a.target.checked}))})," ",e.checkbox]},e.key))}),y?(0,a.jsx)("p",{className:"acc-error",children:y}):null,(0,a.jsx)("button",{className:"cta-button",disabled:p||!I,onClick:()=>void j(),children:p?"Recording your acceptance…":`Accept & open your ${(0,f.formatUsd)(f.BALANCE_AMOUNT_CENTS)} balance invoice`}),k?null:(0,a.jsx)("p",{className:"acc-sign-hint",children:"Each box unlocks once its document has been opened — the record of your acceptance includes the exact text you read."})]})]})}function T({entryId:e,token:i}){let[n,o]=(0,t.useState)(!1),[l,c]=(0,t.useState)(null),d=(0,r.useMutation)(s.api.acceptLink.accept);async function h(){o(!0),c(null);try{let a=await d({entryId:e,token:i});a.ok||c(v(a.error??""))}catch{c("Something went wrong. Please try again.")}finally{o(!1)}}return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("h1",{className:"shell-title",children:"Your acceptance is recorded."}),(0,a.jsxs)("section",{className:"panel acc-notice",children:[(0,a.jsx)("p",{children:"Your acceptance is recorded, but preparing the invoice hit a snag. You can retry right here — nothing has been charged."}),l?(0,a.jsx)("p",{className:"acc-error",children:l}):null,(0,a.jsx)("button",{className:"cta-button acc-action",disabled:n,onClick:()=>void h(),children:n?"Retrying…":"Retry preparing my invoice"})]})]})}function I({state:e}){return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("h1",{className:"shell-title",children:"Your terms are on file."}),(0,a.jsxs)("section",{className:"panel",children:[(0,a.jsxs)("p",{children:["Your acceptance of all three documents is recorded",e.name?`, ${e.name}`:""," — one step left."]}),(0,a.jsxs)("a",{className:"cta-button acc-action",href:e.hostedInvoiceUrl,target:"_blank",rel:"noreferrer",children:["Pay ",(0,f.formatUsd)(f.BALANCE_AMOUNT_CENTS)," on Stripe"]}),(0,a.jsxs)("p",{className:"acc-fine",children:["Due"," ",e.dueAt?new Date(e.dueAt).toLocaleDateString(void 0,{dateStyle:"long"}):f.BALANCE_DUE_LABEL,e.stripeNumber?` \xb7 Invoice ${e.stripeNumber}`:"",". Keep this link — it always brings you back to this invoice. The Stripe page has the printable version if your employer is reimbursing you, and paid invoices include a downloadable PDF receipt."]}),(0,a.jsx)("p",{className:"acc-fine",children:"On file: your acceptance of the Participant Agreement, the Liability Waiver & Release, and the Privacy Notice."})]})]})}e.s(["AcceptFlow",0,function(){let e=function(){let e="",a="";try{let t=(0,n.useSearchParams)();e=t.get("e")??"",a=t.get("t")??""}catch{}return{entryId:e,token:a}}(),t=(0,r.useQuery)(s.api.acceptLink.inspect,{entryId:e.entryId,token:e.token});return(0,a.jsxs)("div",{className:"shell accept-shell",children:[(0,a.jsxs)("header",{className:"shell-header",children:[(0,a.jsxs)("div",{className:"shell-brand",children:[(0,a.jsx)(i.default,{href:"/",children:"Learn Anything"}),(0,a.jsx)("span",{className:"shell-tag",children:"Participant Terms"})]}),(0,a.jsx)("nav",{className:"shell-nav",children:(0,a.jsx)(i.default,{href:"/",className:"shell-link",children:"Landing"})})]}),(0,a.jsx)("main",{className:"shell-main",children:void 0===t?(0,a.jsx)("p",{className:"acc-loading",children:"Loading…"}):(0,a.jsx)(x,{state:t,entryId:e.entryId,token:e.token})}),(0,a.jsxs)("footer",{className:"acc-footer",children:[(0,a.jsxs)("p",{children:["Questions about any of this? Reply to your email, or write to"," ",(0,a.jsx)("a",{href:"mailto:eric.ma@nonlinearlabs.ai",children:"eric.ma@nonlinearlabs.ai"}),"."]}),(0,a.jsx)("p",{className:"acc-footer-brand",children:(0,a.jsx)(i.default,{href:"/",children:"Learn Anything"})})]})]})}],95742)}]);